            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <form role="form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <asp:TextBox runat="server" ID="FName" CssClass="form-control input-lg" placeholder="First Name" />
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="FName" CssClass="text-danger" ErrorMessage="First Name field is required." />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <asp:TextBox runat="server" ID="LName" CssClass="form-control input-lg" placeholder="Last Name" />
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="LName" CssClass="text-danger" ErrorMessage="Last Name field is required." />
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <asp:TextBox runat="server" ID="Email" CssClass="form-control input-lg" placeholder="Email Address" Textmode="Email" />
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <asp:TextBox runat="server" ID="Password" CssClass="form-control input-lg" placeholder="Password" TextMode="Password" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <asp:TextBox runat="server" ID="ConfirmPassword" CssClass="form-control input-lg" placeholder="Confirm Password" TextMode="Password" />
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ConfirmPassword" CssClass="text-danger" Display="Dynamic" ErrorMessage="Confirm Password field is required." />
