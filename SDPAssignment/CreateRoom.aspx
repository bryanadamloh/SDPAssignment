<%@ Page Title="Create Room" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site-Staff.Master" CodeBehind="CreateRoom.aspx.vb" Inherits="SDPAssignment.CreateRoom" %>
    ...
    <div class="container-fluid" style="padding: 90px 50px;">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <h1 class="text-center">Create Hotel Rooms</h1>
                <p class="text-center" style="font-size:14px; font-weight:600; margin-top:20px;">
                    Create new hotel rooms for Orient Hotel
                </p>
                ...
                <form>
                    ...
                    <div class="pull-left">
                        <asp:Button runat="server" OnClick="CreateRoom" CssClass="btn btn-primary" Text="Create" /> 
                    </div>
                </form>
            </div>
        </div>
