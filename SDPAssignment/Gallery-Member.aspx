        ...
        <div class="col-md-12">
            ...
            <div class="container-fluid col-md-12" style="padding: 70px 50px;">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/Broadway%20Lounge.JPG" title="Lounge Bar">
                            <img class="img-responsive" src="Images/Broadway%20Lounge.JPG" alt="">
                        </a>
                    </div>

                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/conferenceRoom.jpg" title="Conference Room for meetings">
            ...
            <div class="container-fluid col-md-12" style="padding: 70px 50px;">
                <div class="row">
                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/deluxe1500x930.jpg" title="Family Suite hotel room">
                            <img class="img-responsive" src="Images/deluxe1500x930.jpg" alt="">
                        </a>
                    </div>

                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/timessquare_50.jpg" title="Times Square Swimming Pool">
                            <img class="img-responsive" src="Images/timessquare_50.jpg" alt="">
                        </a>
                    </div>

                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/hotelentrance.jpg" title="Architecture of Orient Hotel">
            ...
            <div class="container-fluid col-md-12" style="padding: 70px 50px;">
                <div class="row">
                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/hotel-buddha-bar-budapest-banqueting-01.jpg" title="Fine dining restaurant">
                            <img class="img-responsive" src="Images/hotel-buddha-bar-budapest-banqueting-01.jpg" alt="">
                        </a>
                    </div>

                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/hotelritz-Entrance%201.jpg" title="Parking valet service">
                            <img class="img-responsive" src="Images/hotelritz-Entrance%201.jpg" alt="">
                        </a>
                    </div>

                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/the-dorchester-the-grill-at-the-dorchester.jpg" title="Italian Cuisine Restaurant">
            ...
            <div class="container-fluid col-md-12" style="padding: 70px 50px;">
                <div class="row">
                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/The-Address-Downtown-Dubai-Cigar-Lounge-Terrace.jpg" title="Breathtaking view at night">
                            <img class="img-responsive" src="Images/The-Address-Downtown-Dubai-Cigar-Lounge-Terrace.jpg" alt="">
                        </a>
                    </div>

                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/hotel-interior-room0416.jpg" title="Double Suite Hotel Room">
                            <img class="img-responsive" src="Images/hotel-interior-room0416.jpg" alt="">
                        </a>
                    </div>

                    <div class="col-md-4">
                        <a class="fancybox" rel="fancyboxgallery" href="Images/hotelroom.jpg" title="Queen Suite Hotel Room">
